<template>
  <!-- component -->
  <aside class="flex bg-gray-700">
    <div
      class="flex flex-col items-center w-16 h-screen py-8 space-y-8 dark:bg-gray-900 dark:border-gray-700 bg-gray-700"
    >
      <a href="#">
        <img
          class="w-auto h-10 w-10"
