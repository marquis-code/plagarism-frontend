  ...
  <main>
    <section class="overflow-hidden sm:grid sm:grid-cols-2 lg:mt-32">
      <img
        ...
        class="h-full w-full object-cover lg:h-[780px] md:hidden"
      />
      <div class="p-8 md:p-12 lg:px-16 lg:py-24">
        <div class="mx-auto max-w-xl ltr:sm:text-left rtl:sm:text-right">
          ...
          <p class="text-gray-500 md:mt-4 md:block leading-loose text-justify">
            Plagiarism checking is the process of using tools or methods to
            examine a piece of writing or content to identify and detect
            instances of plagiarism. Plagiarism occurs when someone presents
            someone else's work, ideas, or intellectual property as their own
            without giving proper credit. Plagiarism checking can be done
            manually or through specialized software that compares the text
            against a database of existing content to identify potential matches
            or similarities. The goal is to ensure the originality of the work
    ...
    <section class="overflow-hidden sm:grid sm:grid-cols-2 mt-10 lg:mt-32">
      <img
        ...
        class="h-full w-full object-cover lg:h-[780px]"
      />
      <div class="p-8 md:p-12 lg:px-16 lg:py-24">
        <div class="mx-auto max-w-xl ltr:sm:text-left rtl:sm:text-right">
          <h2 class="text-2xl font-bold text-gray-900 md:text-3xl">
      ...
      <div class="p-8 md:p-12 lg:px-16 lg:py-24">
        <div class="mx-auto max-w-xl ltr:sm:text-left rtl:sm:text-right">
          ...
          <p class="text-gray-500 md:mt-4 md:block leading-loose text-justify">
            ...
            report highlighting potential instances of plagiarism. It helps
            users identify and address issues related to originality, proper
            citation, and ethical writing by flagging similarities and providing
            a percentage of overall similarity.
          </p>
