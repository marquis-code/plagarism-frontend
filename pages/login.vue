          ...
          <form class="mt-8 w-full space-y-6" @submit.prevent="handleLogin">
            ...
            <div class="w-full">
              <button
                ...
                class="w-full shrink-0 disabled:opacity-25 disabled:cursor-not-allowed rounded-md border bg-black px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent"
              >
              ...
              >
                ...
                <nuxt-link to="/signup" class="text-gray-700 underline">
                  Sign up </nuxt-link
                >.
              </p>
            </div>
